      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          <h1 className="text-6xl  font-bold text-white">
            <span className="text-orange-400">Sport</span><span>Nest</span>
          </h1>
          <p className="mt-4 max-w-xl">
            Find the perfect place for your next game or adventure and make every moment unforgettable.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="hover:text-white cursor-pointer">All Facilities</li>
